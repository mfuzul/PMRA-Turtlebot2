    ...
    switch(joint)
        case 'arm'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_widowx_shoulder_joint_conf', enabled, ...
        ...
        case 'biceps'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_widowx_biceps_joint_conf', enabled, ...
                robot.vrep.simx_opmode_oneshot);  
        
        case 'forearm'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_widowx_forearm_joint_conf', enabled, ...
                robot.vrep.simx_opmode_oneshot);  

        case 'wrist'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_widowx_wrist_joint_conf', enabled, ...
                robot.vrep.simx_opmode_oneshot);
               
        case 'gripper'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_widowx_gripper_joint_conf', enabled, ...
                robot.vrep.simx_opmode_oneshot);
